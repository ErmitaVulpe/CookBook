...
John Gruber's [canonical description of Markdown's syntax](https://daringfireball.net/projects/markdown/syntax)
...
1.  How much indentation is needed for a sublist?  The spec says that
    ...
    users in real documents. (See [this comment by John Gruber](https://web.archive.org/web/20170611172104/http://article.gmane.org/gmane.text.markdown.general/1997).)
...
Note that not every feature of the HTML samples is mandated byk
